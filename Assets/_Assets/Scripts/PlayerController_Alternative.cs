...
public class PlayerController_Alternative : MonoBehaviour
{
    //The propellers
    ...
    //The PID controllers
    private PIDController_Alternative PID_pitch;
    private PIDController_Alternative PID_roll;
    private PIDController_Alternative PID_yaw;
    ...
    void Start()
    {
        ...
        if (PID_pitch)
        {
            if ((PID_pitch == null) && (GameObject.Find("Drone").gameObject.GetComponent<PIDController_Alternative>() != null))
            {
                PID_pitch = GameObject.Find("Drone").gameObject.GetComponent<PIDController_Alternative>();
            }
            else
            {
                Debug.LogWarning("Missing PIDController_Alternative component. Please add one");
            }
        }

        if (PID_roll)
        {
            if ((PID_roll == null) && (GameObject.Find("Drone").gameObject.GetComponent<PIDController_Alternative>() != null))
            {
                PID_roll = GameObject.Find("Drone").gameObject.GetComponent<PIDController_Alternative>();
            }
            else
            {
                Debug.LogWarning("Missing PIDController_Alternative component. Please add one");
        ...
        if (PID_yaw)
        {
            if ((PID_yaw == null) && (GameObject.Find("Drone").gameObject.GetComponent<PIDController_Alternative>() != null))
            {
                PID_yaw = GameObject.Find("Drone").gameObject.GetComponent<PIDController_Alternative>();
            }
            else
            {
                Debug.LogWarning("Missing PIDController_Alternative component. Please add one");
